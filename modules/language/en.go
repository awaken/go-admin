...
var en = LangSet{
	...
	"plugin.info":                           "Detail",
	"plugin.login":                          "Login",
	"plugin.login to goadmin member system": "Login to member system",
	...
	"plugin.can not connect to the goadmin remote server": "Failed to connect the remote server, check your network connection.",

	"admin.basic admin": "Basic Admin",
	"admin.a built-in plugins to build a crud manager platform quickly.": "A built-in pluginto build a crud manager platform quickly.",
	...
	"system.env_prod"    : "Production",
	"system.env_dev"     : "Development",
	"system.env_test"    : "Test",
	"system.env_local"   : "Local",
	"system.app_host_ip" : "App Host / IP",
	"system.app_commit"  : "App Commit",
	"system.app_build_at": "App Build At",
}
